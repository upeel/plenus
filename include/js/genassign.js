var processUrl = "genassignformActions.jsp";
...
function checkMandatory(){ 
    var cbGen = addForm.elements["cbGen"].value; 
    var cbActRes = addForm.elements["cbActRes"].value;
    if(cbGen == null || cbGen == "0"){
        addForm.elements["cbGen"].style.background = '#F88888';
        return false;
    } else{ 
        addForm.elements["cbGen"].style.background = '#FFFFFF';
    } 
    
    if(cbActRes == null || cbActRes == "0_0_0"){
        addForm.elements["cbActRes"].style.background = '#F88888';
        alert("Please provide all Mandatory Fields!");
        return false;
    } else{
        addForm.elements["cbActRes"].style.background = '#FFFFFF';
    }
    return true;
}
